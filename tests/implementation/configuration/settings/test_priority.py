from ptero_petri.implementation.configuration.settings.cache import CacheSettings
from ptero_petri.implementation.configuration.settings.priority import PrioritySettings
import mock
import unittest
